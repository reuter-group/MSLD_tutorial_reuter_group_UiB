...
ini=41 # phase 3 starts with this #
iri=36
ifi=50  # phase 3 ends with this #
...
# timeout -s SIGINT 8h
echo "run$i started"
mpirun -np $nreps -x OMP_NUM_THREADS=8 --map-by node $CHARMMEXEC iflat=$i esteps=125000 nsteps=250000 seed=$RANDOM -i ../msld_flat.inp > output 2> error

3mpirun -n $nreps $CHARMMEXEC iflat=$i esteps=125000 nsteps=250000 seed=$RANDOM -i ../msld_flat.inp > output 2> error
