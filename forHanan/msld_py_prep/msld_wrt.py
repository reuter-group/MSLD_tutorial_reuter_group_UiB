...
def writeALF_Files(sysname,outdir,cgenff):
    ...
    fp.write("image byres xcen 0 ycen 0 zcen 0 sele resn tip3 .or. resn pot .or. resn sod .or. resn cla end\n")
    fp.write("image byseg xcen 0 ycen 0 zcen 0 sele .not. ( resn tip3 .or. resn pot .or. resn sod .or. resn cla ) end\n\n")
